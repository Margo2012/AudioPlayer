...
import com.example.audio_player_10.service.PlayerService;

public class MainActivity extends AppCompatActivity {

    private PlayerService.PlayerServiceBinder playerServiceBinder;

    //Создаем экземпляр MediaController и передаем в конструктор полученный из сервиса токен.
    //MediaController предоставляет как методы управления плеером, так и
    // коллбэки onPlaybackStateChanged(PlaybackState state) и onMetadataChanged(MediaMetadata metadata).
